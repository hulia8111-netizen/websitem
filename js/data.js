...
const DATA = {
  ...
  kartlar: [
    ...
    { baslik: "Aile",                img: "Görsellerim/AİLE.jpg",                  mesaj: "Köklerin seni besliyor; sevdiklerinle sevgi bağını güçlendir." },
    { baslik: "Alma-Verme Dengesi",  img: "Görsellerim/ALMA-VERME DENGESİ.jpg",    mesaj: "Vermek kadar almayı da öğren; denge huzur getirir." },
    { baslik: "Bağ",                 img: "Görsellerim/BAĞ.jpg",                   mesaj: "Kalpten kurulan bağlar seni büyütür; bağ kur." },
    { baslik: "Başarı",              img: "Görsellerim/BAŞARI.jpg",                mesaj: "Emeğin meyveye duruyor; başarı çok yakın." },
    { baslik: "Bekle",               img: "Görsellerim/BEKLE.jpg",                 mesaj: "Henüz değil. Sabırla bekle; doğru zaman geliyor." },
    { baslik: "Bırak",               img: "Görsellerim/BIRAK.jpg",                 mesaj: "Tutunduğun yükü bırak; bırakınca hafifleyeceksin." },
    { baslik: "Davet",               img: "Görsellerim/DAVET.jpg",                 mesaj: "Evren seni güzel bir şeye davet ediyor; kabul et." },
    { baslik: "Değer",               img: "Görsellerim/DEĞER.jpg",                 mesaj: "Değerin koşulsuz; olduğun gibi yeterlisin." },
    { baslik: "Doğa",                img: "Görsellerim/DOĞA.jpg",                  mesaj: "Doğaya dön; o seni dengeler ve iyileştirir." },
    { baslik: "Duygusal Netlik",     img: "Görsellerim/DUYGUSAL NETLİK.jpg",       mesaj: "Duygularını dinle; netlik kalbinden gelir." },
    { baslik: "Düzen",               img: "Görsellerim/DÜZEN.jpg",                 mesaj: "Dışını sadeleştir; içsel düzenin oradan doğar." },
    { baslik: "Emek",                img: "Görsellerim/EMEK.jpg",                  mesaj: "Verdiğin emek boşa değil; tohumların filizleniyor." },
    { baslik: "Hak Ediyorum",        img: "Görsellerim/HAKEDİYORUM.jpg",           mesaj: "İyi olan her şeyi hak ediyorsun; almaya açıl." },
    { baslik: "Hediye",              img: "Görsellerim/HEDİYE.jpg",                mesaj: "Hayat sana bir hediye hazırlıyor; gözlerini aç." },
    { baslik: "İçindeki Çocuk",      img: "Görsellerim/İÇİNDEKİ ÇOCUK.jpg",        mesaj: "İçindeki çocuğa şefkat göster; oyna, gül, sev." },
    { baslik: "İlham",               img: "Görsellerim/İLHAM.jpg",                 mesaj: "İlham içinden akıyor; o sese kulak ver." },
    { baslik: "Kapı Açıldı",         img: "Görsellerim/KAPI AÇILDI.jpg",           mesaj: "Yeni bir kapı açıldı; cesaretle eşikten geç." },
    { baslik: "Mühür",               img: "Görsellerim/MÜHÜR.jpg",                 mesaj: "Niyetini mühürle; kararlılığın yolu açar." },
    { baslik: "Seçim Yap",           img: "Görsellerim/SEÇİM YAP.jpg",             mesaj: "Karar senin elinde; kalbinin sesini seç." },
    { baslik: "Seyahat",             img: "Görsellerim/SEYAHAT.jpg",               mesaj: "Yeni ufuklar seni çağırıyor; yola çık." },
    { baslik: "Şefkat",              img: "Görsellerim/ŞEFKAT.jpg",                mesaj: "Önce kendine şefkat göster; sevgi oradan taşar." },
    { baslik: "Şimdi Anda Kal",      img: "Görsellerim/ŞİMDİ ANDA KAL.jpg",        mesaj: "Geçmiş geçti, gelecek belirsiz; gücün bu anda." },
    { baslik: "Tam Zamanı",          img: "Görsellerim/TAM ZAMANI.jpg",            mesaj: "Beklediğin an bu; harekete geçmenin tam zamanı." },
    { baslik: "Topraklanmak",        img: "Görsellerim/TOPRAKLANMAK.jpg",          mesaj: "Ayaklarını yere bas; köklen ve dengelen." },
    { baslik: "Uyanış",              img: "Görsellerim/UYANIŞ.jpg",                mesaj: "İçinde bir şey uyanıyor; ışığını fark et." },
    { baslik: "Uzak",                img: "Görsellerim/UZAK.jpg",                  mesaj: "Sana iyi gelmeyenden uzaklaş; enerjini koru." },
  ...
  rehberMeditasyonlari: [
    { id: "rm1", ad: "İçsel Huzur Yolculuğu",   aciklama: "Rehberin sesiyle derin bir sükûnete in.",        ses: "Meditasyon seslerim/1.mp3" },
