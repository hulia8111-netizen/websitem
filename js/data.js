...
const DATA = {
  ...
  kartlar: [
    { baslik: "Taşınma",       img: "Görsellerim/TAŞINMA.jpg",        mesaj: "Bir değişim kapıda. Eskiyi bırakmaya hazır ol.", derin: "Her değişim, ruhunun daha geniş bir alana aktığının işaretidir. Yıkılan duvarlar seni koruyan değil, kısıtlayandı; geride ne bıraktığına değil, açılan boşluğa neyi çağırdığına odaklan." },
    { baslik: "Yükseliş",      img: "Görsellerim/YÜKSELİŞ.jpg",       mesaj: "Enerjin yükseliyor. Kendini daha yükseğe taşı.", derin: "Yükselmek başkalarını geçmek değil, kendi titreşimini yükseltmektir. Seni aşağı çeken düşünceleri nazikçe bırak; enerjin yükseldikçe aynı frekanstaki güzellikler sana yaklaşır." },
    { baslik: "İlerle",        img: "Görsellerim/İLERLE.jpg",         mesaj: "Durma vakti değil. Bir adım daha at.", derin: "İlerlemek büyük sıçramalar değil, küçük ve kararlı adımlardır. Mükemmel anı bekleme; yol, yürürken belirir. Büyümek hep konfor eşiğinin bir adım ötesindedir." },
    { baslik: "Sorumluluk",    img: "Görsellerim/SORUMLULUK.jpg",     mesaj: "Hayatının dümeni sende. Sahiplen.", derin: "Sorumluluk bir yük değil, gücünü geri almaktır. Hayatını dışsal koşullara teslim ettiğinde küçülürsün; dümeni eline aldığında ise en küçük seçim bile seni özgürleştirir." },
    { baslik: "Netlik",        img: "Görsellerim/NETLİK.jpg",         mesaj: "Sis dağılıyor. Gerçek niyetini gör.", derin: "Netlik tüm cevapları bilmek değil, bir sonraki adımı görebilmektir. Zihnindeki gürültü dindiğinde gerçek niyetin hep oradaydı zaten. Kafan karıştığında dışarıya değil içeriye sor." },
    { baslik: "Temizlik",      img: "Görsellerim/TEMİZLİK.jpg",       mesaj: "Sana hizmet etmeyeni bırak. Alan aç.", derin: "Sana hizmet etmeyen düşünceler, ilişkiler ve alışkanlıklar enerjini sessizce tüketir. Bir şeyi bırakmak, hayatına yeninin girmesi için alan açmaktır. Boşluk kayıp değil, davettir." },
    { baslik: "Biliyorsun",    img: "Görsellerim/BİLİYORSUN.jpg",     mesaj: "Cevap zaten içinde. Sezgine güven.", derin: "En derin cevaplar mantığın değil, sezginin dilinden gelir. Zaten bildiğin şeyi görmezden gelmeyi bırak; bedenin sana 'evet' ya da 'hayır' diyor. O ilk sessiz bilişe güven." },
    { baslik: "Arınma",        img: "Görsellerim/ARINMA.jpg",         mesaj: "Sana ağırlık veren her şeyi bırak; arın ve hafifle.", derin: "Arınmak kendini eksik görmek değil, taşıdığın fazlalıklardan hafiflemektir. Sana ait olmayan suçluluğu, korkuyu ve başkalarının beklentilerini bırak. Arındıkça öz benliğin parlar." },
    { baslik: "Dur",           img: "Görsellerim/DUR.jpg",            mesaj: "Biraz dur, nefes al. Acele etmene gerek yok.", derin: "Durmak geri kalmak değil, kendine dönmektir. Sürekli koşan zihin en basit cevabı bile göremez. Bir nefes al; acele ettiğin şey belki de sabırla daha güzel açılacak." },
    { baslik: "Güvendesin",    img: "Görsellerim/GÜVENDESİN.jpg",     mesaj: "Korkma; tam da olman gereken yerdesin, güvendesin.", derin: "Korku çoğu zaman gerçek tehlike değil, kontrol edememe hissidir. Tam da olman gereken yerdesin; her şey planına göre gitmese de yolun seni taşıyor. Bugün biraz daha gevşemene izin ver." },
    { baslik: "Hatırla",       img: "Görsellerim/HATIRLA.jpg",        mesaj: "Ne kadar güçlü olduğunu hatırla.", derin: "Zor anlar sana ne kadar kırılgan olduğunu değil, kaç fırtınadan sağ çıktığını gösterir. Gücün yeni değil, sadece unuttun. Geçmişte aştıklarını hatırla — aynı güç hâlâ içinde." },
    { baslik: "Huzur",         img: "Görsellerim/HUZUR.jpg",          mesaj: "Huzur dışarıda değil, içinde. Oraya dön.", derin: "Huzuru dışarıda ararsan hep bir sonraki şeye ertelersin. O, koşullar değiştiğinde değil, sen içine döndüğünde belirir. Bugün bir an için hiçbir şeyi düzeltmeye çalışmadan öylece ol." },
    { baslik: "Kendin Ol",     img: "Görsellerim/KENDİN OL.jpg",      mesaj: "Maskeleri bırak; en güzel halin, gerçek halin.", derin: "Beğenilmek için taktığın maskeler seni yorar ve gerçek bağlardan uzaklaştırır. En sevilesi halin, cilalanmış değil samimi olan halindir. Kendin olmak cesaret ister ama tek gerçek özgürlük odur." },
    { baslik: "Liderlik",      img: "Görsellerim/LİDERLİK.jpg",       mesaj: "Önce kendi hayatının lideri ol.", derin: "Liderlik başkalarını yönetmek değil, önce kendi hayatına sahip çıkmaktır. Kendi değerlerine sadık kaldığında kimseyi ikna etmene gerek kalmaz. İçindeki netlik çevrene doğal bir güven yayar." },
    { baslik: "Bolluk",        img: "Görsellerim/PARA.jpg",           mesaj: "Bolluk sana akıyor; almaya izin ver.", derin: "Bolluk sadece para değil; sevgi, fırsat, sağlık ve huzurun serbestçe akışıdır. Çoğu zaman kapı kapalı değil, sen almaya izin vermiyorsun. Bugün 'yeterince yok' korkusunu bırak, ellerini aç." },
    { baslik: "Paylaşım",      img: "Görsellerim/PAYLAŞIM.jpg",       mesaj: "Verdikçe çoğalır; sevgiyle paylaş.", derin: "Sevgi, bilgi ve bereket paylaştıkça azalmaz, çoğalır. Kıtlık zihniyeti biriktirmeye iter; oysa cömertlik, evrene 'yeterince var' demenin en güçlü yoludur. Bugün karşılıksız bir şey ver." },
    { baslik: "Sadelik",       img: "Görsellerim/SADELİK.jpg",        mesaj: "Sadeleş; gereksizi bırak, öz olana yer aç.", derin: "Karmaşa çoğu zaman dışarıda değil, zihnindeki fazlalıktadır. Bir şeyi eksiltmek hayatını fakirleştirmez; öz olana yer açar. En derin huzur en sade anlarda gizlidir." },
    { baslik: "Çekim Başladı", img: "Görsellerim/ÇEKİM BAŞLADI.jpg",  mesaj: "İstediğin şey sana doğru harekete geçti.", derin: "İçtenlikle istediğin şey, sen fark etmeden yola çıktı bile. Görevin zorlamak değil, akışa güvenmek ve hazır olmaktır. Kapı çalmadan önce evi hazırla." },
    { baslik: "İtibar",        img: "Görsellerim/İTİBAR.jpg",         mesaj: "Değerini bil; kendine saygıyla davran.", derin: "Başkalarının sana davranışı çoğu zaman senin kendine davranışının yankısıdır. Değerini içten bildiğinde onaylanma ihtiyacın azalır. Bugün kendine bir saygı jesti göster." },
    { baslik: "Şimdi",         img: "Görsellerim/ŞİMDİ.jpg",          mesaj: "Güç şimdidedir. Ana dön.", derin: "Zihnin geçmişin pişmanlığı ile geleceğin kaygısı arasında salınırken, tek gerçek güç bu anda bekliyor. Şimdiye döndüğünde kaygı yatışır. Şu nefes, sahip olduğun tek gerçek zaman." },
    { baslik: "Aile",                img: "Görsellerim/AİLE.jpg",                  mesaj: "Köklerin seni besliyor; sevdiklerinle sevgi bağını güçlendir.", derin: "Kökler ağacı sabitler ama aynı zamanda besler. Sevdiklerinle bağ geçmişin yükü değil, bugünün sığınağı olabilir. Onarmak istediğin bir bağ varsa ilk adımı sevgiyle sen at." },
    { baslik: "Alma-Verme Dengesi",  img: "Görsellerim/ALMA-VERME DENGESİ.jpg",    mesaj: "Vermek kadar almayı da öğren; denge huzur getirir.", derin: "Hep veren tükenir, hep alan boşalır; ruh dengeyle nefes alır. Almak zayıflık değil, akışın yarısıdır. Bugün ne kadar verdiğini değil, almaya ne kadar izin verdiğini sor." },
    { baslik: "Bağ",                 img: "Görsellerim/BAĞ.jpg",                   mesaj: "Kalpten kurulan bağlar seni büyütür; bağ kur.", derin: "Yüzeysel bağlar oyalar, kalpten kurulanlar büyütür. Kendini olduğun gibi gösterdiğinde gerçek bağ başlar. Bir bağı derinleştirmek istiyorsan önce kendi kalbini biraz daha aç." },
    { baslik: "Başarı",              img: "Görsellerim/BAŞARI.jpg",                mesaj: "Emeğin meyveye duruyor; başarı çok yakın.", derin: "Başarı bir varış noktası değil, emeğine sadık kalmanın doğal meyvesidir. Şu an göremesen de tohumların olgunlaşıyor. Vazgeçmek istediğin an, çoğu zaman eşiğe en yakın olduğun andır." },
    { baslik: "Bekle",               img: "Görsellerim/BEKLE.jpg",                 mesaj: "Henüz değil. Sabırla bekle; doğru zaman geliyor.", derin: "Her tohum kendi mevsiminde açar; zorlamak sadece yorar. Beklemek edilgenlik değil, güvenle hazırlanmaktır. Henüz olmayan şey yanlış değil, sadece erken olabilir." },
    { baslik: "Bırak",               img: "Görsellerim/BIRAK.jpg",                 mesaj: "Tutunduğun yükü bırak; bırakınca hafifleyeceksin.", derin: "Tutunduğun şey seni koruyor gibi görünse de çoğu zaman ilerlemeni engelliyordur. Bırakmak kaybetmek değil, ellerini yeni olana açmaktır. Kontrolü bıraktığında hafifleyeceksin." },
    { baslik: "Davet",               img: "Görsellerim/DAVET.jpg",                 mesaj: "Evren seni güzel bir şeye davet ediyor; kabul et.", derin: "Evren sana çoğu zaman fısıltıyla, bir sezgiyle, bir tesadüfle sesleniyor. Güzel olana açılmak için mükemmel hissetmeni beklemiyor. Bugün gelen daveti reddetme; belki tam da onu bekliyordun." },
    { baslik: "Değer",               img: "Görsellerim/DEĞER.jpg",                 mesaj: "Değerin koşulsuz; olduğun gibi yeterlisin.", derin: "Değerin başarılarına, sahip olduklarına ya da başkalarının onayına bağlı değildir. Sen hiçbir şey yapmadan da yeterlisin. Bunu içinde hissettiğinde dünya sana farklı davranır." },
    { baslik: "Doğa",                img: "Görsellerim/DOĞA.jpg",                  mesaj: "Doğaya dön; o seni dengeler ve iyileştirir.", derin: "Zihnin dağıldığında en hızlı ilaç toprağa, ağaca, gökyüzüne dönmektir. Doğa seni yargılamadan dengeler. Bugün birkaç dakika bile olsa dışarı çık, nefes al, köklen." },
    { baslik: "Duygusal Netlik",     img: "Görsellerim/DUYGUSAL NETLİK.jpg",       mesaj: "Duygularını dinle; netlik kalbinden gelir.", derin: "Netlik her zaman zihinden değil, çoğu zaman kalpten gelir. Bastırdığın duygu sana bir mesaj taşıyor. Onu yargılamadan dinlediğinde gerçek ihtiyacın ortaya çıkar." },
    { baslik: "Düzen",               img: "Görsellerim/DÜZEN.jpg",                 mesaj: "Dışını sadeleştir; içsel düzenin oradan doğar.", derin: "Dışarıdaki dağınıklık çoğu zaman içerideki karmaşanın aynasıdır. Küçük bir köşeyi sadeleştirmek zihnine de nefes aldırır. Düzen kısıtlama değil, huzurun zeminidir." },
    { baslik: "Emek",                img: "Görsellerim/EMEK.jpg",                  mesaj: "Verdiğin emek boşa değil; tohumların filizleniyor.", derin: "Görünmeyen emek boşa gitmez; toprağın altında filizlenen tohumlar gibi. Hemen sonuç görmesen de büyüme sessizce sürüyor. Kendine güven ve emeğini sevgiyle sürdür." },
    { baslik: "Hak Ediyorum",        img: "Görsellerim/HAKEDİYORUM.jpg",           mesaj: "İyi olan her şeyi hak ediyorsun; almaya açıl.", derin: "İyi şeyleri hak etmediğin hissi çoğu zaman sana ait bile değil — öğrenilmiş bir sestir. Sevgiyi, bolluğu, huzuru hak ediyorsun. Bugün 'ben buna layığım' de ve almaya izin ver." },
    { baslik: "Hediye",              img: "Görsellerim/HEDİYE.jpg",                mesaj: "Hayat sana bir hediye hazırlıyor; gözlerini aç.", derin: "Hayat bazen zorluk kılığında hediyeler saklar. Gözlerini açık tuttuğunda en beklenmedik anda bir armağan belirir. Şükranla bakan göz her yerde bereketi görür." },
    { baslik: "İçindeki Çocuk",      img: "Görsellerim/İÇİNDEKİ ÇOCUK.jpg",        mesaj: "İçindeki çocuğa şefkat göster; oyna, gül, sev.", derin: "İçindeki çocuk hâlâ oyun, şefkat ve kabul bekliyor. Ona sert değil nazik ol; gülmesine, hata yapmasına izin ver. Onu iyileştirdiğinde kalbin de hafifler." },
    { baslik: "İlham",               img: "Görsellerim/İLHAM.jpg",                 mesaj: "İlham içinden akıyor; o sese kulak ver.", derin: "İlham dışarıdan gelen bir şey değil, içindeki sesin serbest kalmasıdır. Zihnin sustuğunda o ses netleşir. Bugün aklına düşen o küçük fikri küçümseme; belki de sana bir kapı açıyor." },
    { baslik: "Kapı Açıldı",         img: "Görsellerim/KAPI AÇILDI.jpg",           mesaj: "Yeni bir kapı açıldı; cesaretle eşikten geç.", derin: "Bir dönem kapanırken çoğu zaman fark etmediğin yeni bir kapı aralanır. Eşikte tereddüt doğaldır ama korku, yeninin yanlış olduğu anlamına gelmez. Cesaretle bir adım at." },
    { baslik: "Mühür",               img: "Görsellerim/MÜHÜR.jpg",                 mesaj: "Niyetini mühürle; kararlılığın yolu açar.", derin: "Niyetini netleştirip ona sadık kaldığında evren senin kararlılığına yanıt verir. Dağınık istekler dağınık sonuçlar getirir. Bugün gerçekten ne istediğini seç ve onu kalbine mühürle." },
    { baslik: "Seçim Yap",           img: "Görsellerim/SEÇİM YAP.jpg",             mesaj: "Karar senin elinde; kalbinin sesini seç.", derin: "Karar vermemek de bir karardır — çoğu zaman en yorucu olanı. Kalbinin sesi mantığın gürültüsünden daha sessiz ama daha bilgedir. Korkudan değil, sevgiden gelen seçeneği seç." },
    { baslik: "Seyahat",             img: "Görsellerim/SEYAHAT.jpg",               mesaj: "Yeni ufuklar seni çağırıyor; yola çık.", derin: "Yeni ufuklar sadece coğrafi değil; yeni bir düşünce, yeni bir cesaret de bir yolculuktur. Konfor alanı güvenli ama küçüktür. Bugün seni büyütecek küçük bir 'yeni'ye adım at." },
    { baslik: "Şefkat",              img: "Görsellerim/ŞEFKAT.jpg",                mesaj: "Önce kendine şefkat göster; sevgi oradan taşar.", derin: "Başkalarına gösterdiğin şefkati çoğu zaman kendinden esirgersin. Oysa sevgi önce senin kendi kalbinden taşar. Bugün kendine, en sevdiğin dosta davrandığın gibi nazik davran." },
    { baslik: "Şimdi Anda Kal",      img: "Görsellerim/ŞİMDİ ANDA KAL.jpg",        mesaj: "Geçmiş geçti, gelecek belirsiz; gücün bu anda.", derin: "Geçmişi değiştiremez, geleceği kontrol edemezsin; ama şu an tamamen senin. Zihnin kaçtığında nazikçe nefesine dön. Yaşam sadece bu anda, burada gerçekleşiyor." },
    { baslik: "Tam Zamanı",          img: "Görsellerim/TAM ZAMANI.jpg",            mesaj: "Beklediğin an bu; harekete geçmenin tam zamanı.", derin: "Sürekli 'daha hazır olunca' demek çoğu zaman korkunun ertelemesidir. Mükemmel an gelmez; sen onu yaratırsın. Beklediğin işaret buysa: tam zamanı." },
    { baslik: "Topraklanmak",        img: "Görsellerim/TOPRAKLANMAK.jpg",          mesaj: "Ayaklarını yere bas; köklen ve dengelen.", derin: "Zihnin bulutlarda dolaşırken huzur, ayaklarını yere basmakta gizli. Nefesini derinleştir, bedenini hisset, ana dön. Köklendiğinde fırtınalar seni deviremez." },
    { baslik: "Uyanış",              img: "Görsellerim/UYANIŞ.jpg",                mesaj: "İçinde bir şey uyanıyor; ışığını fark et.", derin: "İçinde uzun süredir uyuyan bir farkındalık kıpırdanıyor. Bu huzursuzluk değil, büyümenin sancısıdır. Işığını fark et; artık eski halinle yetinemeyeceğin bir eşiktesin." },
    { baslik: "Uzak",                img: "Görsellerim/UZAK.jpg",                  mesaj: "Sana iyi gelmeyenden uzaklaş; enerjini koru.", derin: "Enerjini tüketen kişi, ortam ya da alışkanlıktan uzaklaşmak bencillik değil, öz saygıdır. Herkesi memnun etmek zorunda değilsin. Bugün sana iyi gelmeyene nazik bir 'hayır' de." },
    { baslik: "Üretim",              img: "Görsellerim/ÜRETİM.jpg",                mesaj: "Yaratıcılığın akıyor; üret, paylaş, çoğalt.", derin: "Yaratıcılık biriktikçe huzursuzluk verir, aktıkça şifa olur. İçindeki fikri kusursuz olsun diye bekletme; üret, paylaş, akıt. Yarattığın şey ruhunun dünyaya bıraktığı izdir." }
  ],
  ...
  enerjiTipleri: [
    ...
    { id: "kozmik", ad: "Kozmik Gezgin",      ikon: "🌌", renk: ["#7c3aed", "#b38cff"], uyumlu: "gunes",  med: "yuksekFrekans",
      oneri: "Hasat Ritüel Meditasyonu", oneriHedef: "meditasyon",
      analiz: "Meraklı, özgür ve genişleyen bir ruhsun. Dönüşümün tam ortasındasın; yeni ihtimallere açıksın.",
